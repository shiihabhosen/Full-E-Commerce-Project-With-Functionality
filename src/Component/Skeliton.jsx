...
const Skeliton = () => {
    return (
        <>
            <div role="status" className="max-w-sm p-4  border-gray-200 rounded-sm shadow-sm animate-pulse md:p-6 ">
                ...
                <div className="flex items-center mt-4">
                    ...
                    <div>
                        ...
                        <div className="w-48 h-2 bg-gray-200 rounded-full dark:bg-gray-500" />
                    </div>
                </div>
