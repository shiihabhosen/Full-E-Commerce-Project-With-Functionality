...
const notify = () => toast.success("Sucsessfully added you product!");
...
const PropsCard = ({
  ...
  return (
    <>
      <ToastContainer />
      <div
        className={`${classNameBox} group relative w-[270px] h-[360px] overflow-hidden cursor-pointer  `}
      >
        <div className="w-full h-[270px] bg-white rounded-[4px] flex justify-center items-center">
          <img onClick={handleProductDetails} src={img} alt="" />
        </div>
