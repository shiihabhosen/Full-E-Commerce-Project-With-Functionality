...
const ProductCard = ({ item, className }) => {
  ...
  return (
    <>
      <div
        className={`${className} group relative w-[270px] h-[360px] overflow-hidden  `}
      >
        ...
        <div className="absolute bottom-[80px] left-0 right-0 translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 px-3">
          <NavLink to="/cart">
            <button
              ...
              className="w-full bg-black py-2 rounded-[4px] font-medium text-sm cursor-pointer"
            >
              Add To Cart
            </button>
          </NavLink>
        ...
        <div className="mt-[190px] px-3">
          ...
          <div className="flex text-[#FFAD33] gap-0.5 items-center">
            ...
            <span className="text-[#808080] pl-3">
