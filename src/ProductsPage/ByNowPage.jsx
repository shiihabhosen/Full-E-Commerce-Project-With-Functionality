        ...
        <div className="w-full h-[600px] flex items-center justify-between">
          ...
          <div className="w-[170px] h-full space-y-4 overflow-y-auto">
            {allproduct.images?.slice(0, 4).map((img, index) => (
              <div
                key={index}
                className="w-[170px] h-[138px] bg-[#F5F5F5] rounded-[4px] flex justify-center items-center"
              >
                <img
                  src={img}
                  alt=""
          ...
          <div className="w-[400px] h-full">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="border-l-2 text-[#00FF66] px-3">
                {allproduct.stock > 0 ? "In Stock" : "Out of Stock"}
              </p>
            </div>
            <div className="border-b-2 border-[#808080]">
              <h4 className="text-[20px] font-medium mt-4">
                ${allproduct.price}
              </h4>
            ...
            <div className="flex justify-between items-center">
              ...
              <Button
                btntext="Buy Now"
                className="py-[10px] px-[48px] text-white text-[16px]"
              />
