...
import AllShopCart from "./AllShopCart";
...
const ShopCategoryCard = () => {
  ...
  useEffect(() => {
    const uniqueCategories = [
      ...new Set(allproduct.map((item) => item.category)),
    ];
    ...
    <Container>
      ...
      <div className="mt-[50px] flex justify-between">
        ...
        <div className="w-[184px]">
          ...
          <div>
            <h3 className="text-[20px] font-bold mb-[15px] mt-10">
              Shop by Color
            </h3>
        ...
        <div className="w-[854px]">
          ...
          <div className="grid grid-cols-3 gap-[30px] mt-10">
            {loading ? (
              ...
              <Paginate itemsPerPage={select} allproduct={allproduct} />
            )}
          </div>
        </div>
      </div>
